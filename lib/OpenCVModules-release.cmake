...
set_target_properties(opencv_hdf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_hdf.so.3.4.3"
  IMPORTED_SONAME_RELEASE "libopencv_hdf.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_hdf )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_hdf "${_IMPORT_PREFIX}/lib/libopencv_hdf.so.3.4.3" )
...
set_target_properties(opencv_cvv PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_cvv.so.3.4.3"
  IMPORTED_SONAME_RELEASE "libopencv_cvv.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cvv )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cvv "${_IMPORT_PREFIX}/lib/libopencv_cvv.so.3.4.3" )
...
set_target_properties(opencv_sfm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_sfm.so.3.4.3"
  IMPORTED_SONAME_RELEASE "libopencv_sfm.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_sfm )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_sfm "${_IMPORT_PREFIX}/lib/libopencv_sfm.so.3.4.3" )
